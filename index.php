...
(
    "LMRInfo" => Array(
            ...
            "mortgageNotes" => "",
            "areTaxesInsuranceEscrowed" => "",
            "workNumber" => "777 - 888 - 999",
            "coBorrowerWorkNumber" => "",
            "enc_borrowerName" => "84d9f52d7c42fd6",
            "enc_borrowerLName" => "0782788467c6671",
            "enc_ssnNumber" => "a62aaca808f2c154c72219a9c140220",
            "enc_borrowerDOB" => "5367f0edaea42eecfa8e2039d8819f9",
            "enc_loanNumber" => "",
            "enc_loanNumber2" => "",
            "enc_borrowerEmail" => "34c9676146ff8e5d6b913c027b5f89b01f3e677d3c1dfd7",
            "enc_propertyAddress" => "a606c7432add400853a6d1877899112",
            "enc_propertyCity" => "63b6d2696c9a2c1",
            "enc_propertyState" => "0a3c07c5aa4479a",
            "enc_propertyZip" => "d07e45f5c1d0384",
            ...
            "clientId" => "637418",
            "packageViewed" => "",
            "coBorrowerDOB" => "1976-01-0",
            "coborrowerPOB" => "",
            "dummyId" => "",
            "referralCode1_del" => "",
            "LMRAffiliateCode1_del" => "",
            "executiveId1_del" => "",
            "propertyCounty" => "Miami-Dad",
            "maritalStatus" => "Married",
            "marriageDate" => "",
            "divorceDate" => "",
            "maidenName" => "",
            "mailingAddressAsBorrower" => "",
            "coBorrowerMailingAddress" => "5454 coborMailing s",
            "coBorrowerMailingCity" => "cobMailingCit",
            "coBorrowerMailingState" => "K",
            "coBorrowerMailingZip" => "7865",
                ...
                (
                    ...
                    "144221" => Array
                        (
                            ...
                            "showWorkFlowborrower" => "0",
                            "description" => "Make sure if any disqualifying questions are answered with YES, to mark loans as disqualified and send denial letter. For question that need additional infio, make sure borrower uploads supporting docs for additional businesses owned or details about previous SBA loans.",
                            "coBorrowerRelatedWfstep" => "0",
                            "rehabRelatedWfstep" => "0",
                            "noCrossCollRelatedWfstep" => "0",
                            "usCitizenRelatedWfstep" => "0",
...
var mismo = createLWMismo('{$json}');

var output = document.getElementById("output")
output.innerHTML =   String(mismo).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;'); 
download('mismo_file',mismo);
...
<button onclick="createlwMismo();" style='background-color: hsl(240,100,95); color: hsl(240,100,10); font-size: 2rem; width: 80%; margin-top: 2rem; height: 4rem'>Create MISMO</button>

<pre  style='width: 100%' lang="xml">
</xmp>
<div id="output"> </div>
