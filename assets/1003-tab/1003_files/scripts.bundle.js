...
var KTWizard = function(elementId, options) {
    ...
    var Plugin = {
        ...
        init: function(options) {
            ...
            the.btnSubmit = KTUtil.find(element, '[data-wizard-type="action-submitTemp"]');
		...
		if (KTUtil.attr(_element, 'data-menu-scroll') === '1') {
			scroll = {
				...
				height: function() { // calculate available scrollable area height
					...
					height = height - (parseInt(KTUtil.css(_element, 'marginBottom')) + parseInt(KTUtil.css(_element, 'marginTop')))-55;
 /* 55 added for footer menu*/
					return height;
				}
			};
		}
